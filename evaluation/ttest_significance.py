...
df1 = pd.read_csv('/local/home/USERNAME/project/GoalAgent/causal_planner_human_eval/robot_inter_metric_correlation.csv')
df2 = pd.read_csv('/local/home/USERNAME/project/GoalAgent/causal_planner_human_eval/robothow_metric_correlation.csv')
df3 = pd.read_csv('/local/home/USERNAME/project/GoalAgent/causal_planner_human_eval/wiki_inter_metric_correlation.csv')
df4 = pd.read_csv('/local/home/USERNAME/project/GoalAgent/causal_planner_human_eval/wikihow_metric_correlation.csv')
